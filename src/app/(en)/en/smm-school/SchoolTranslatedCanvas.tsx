...
const layers: Layer[] = [
  ...
  { x: 125, y: 3746, w: 780, h: 195, text: "PEOPLE WHO WANT FREEDOM\nWork online from anywhere in the world and keep travelling.  ↘", size: 25, color: DARK, background: "#fbfafa", radius: 42, padding: 30, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 910, y: 3964, w: 470, h: 196, text: "STUDENTS\nBuild an in-demand skill and earn alongside your studies.  ↘", size: 23, color: DARK, background: "#fbfafa", radius: 42, padding: 28, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 60, y: 4064, w: 575, h: 196, text: "PARENTS ON PARENTAL LEAVE\nLearn a remote profession and earn while staying close to your family.  ↘", size: 22, color: DARK, background: "#fbfafa", radius: 42, padding: 28, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 420, y: 4326, w: 845, h: 195, text: "PEOPLE READY FOR CHANGE\nLeave an unfulfilling job for a creative, in-demand career.  ↘", size: 25, color: DARK, background: "#fbfafa", radius: 42, padding: 30, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  ...
  { x: 88, y: 5030, w: 1264, h: 170, text: "", size: 1, background: DARK },
  { x: 110, y: 5042, w: 1190, h: 45, text: "01  STRATEGY", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 5095, w: 1190, h: 72, text: "Analysis, positioning, content pillars and a practical content plan.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
  { x: 88, y: 5241, w: 1264, h: 168, text: "", size: 1, background: DARK },
  { x: 110, y: 5253, w: 1190, h: 45, text: "02  VISUALS AND CONTENT", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 5306, w: 1190, h: 72, text: "Creative production, layout and video editing — practical skills for everyday work.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
  { x: 88, y: 5452, w: 1264, h: 169, text: "", size: 1, background: DARK },
  { x: 110, y: 5464, w: 1190, h: 45, text: "03  PLATFORMS", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 5517, w: 1190, h: 72, text: "Instagram, Telegram and VK: what makes each platform different and how to grow on it.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
  { x: 88, y: 5662, w: 1264, h: 152, text: "", size: 1, background: DARK },
  { x: 110, y: 5674, w: 1190, h: 45, text: "04  INFLUENCER PARTNERSHIPS", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 5727, w: 1190, h: 60, text: "How to find, assess and brief creators and prepare integrations.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
  { x: 88, y: 5855, w: 1264, h: 158, text: "", size: 1, background: DARK },
  { x: 110, y: 5867, w: 1190, h: 45, text: "05  AI TOOLS", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 5920, w: 1190, h: 60, text: "How to use AI for copy, imagery and faster routine production.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
  { x: 88, y: 6056, w: 1264, h: 279, text: "", size: 1, background: DARK },
  { x: 110, y: 6068, w: 1190, h: 45, text: "06  MARKETING FUNDAMENTALS", size: 30, color: WHITE, lineHeight: 1.05, tracking: -.02, family: "body", weight: 600 },
  { x: 110, y: 6121, w: 1190, h: 72, text: "How content supports sales and helps you make better commercial decisions.", size: 24, color: GRAY, family: "body", lineHeight: 1.15, tracking: -.02 },
...
const mobileLayers: Layer[] = [
  ...
  { x: 20, y: 1872, w: 248, h: 64, text: "PEOPLE WHO WANT FREEDOM\nWork online from anywhere and keep travelling.  ↘", size: 8, color: DARK, background: "#fbfafa", radius: 14, padding: 10, lineHeight: 1.14, family: "body", weight: 600, tracking: -.02 },
  { x: 196, y: 1970, w: 149, h: 64, text: "STUDENTS\nBuild a valuable skill and earn while studying.  ↘", size: 8, color: DARK, background: "#fbfafa", radius: 14, padding: 9, lineHeight: 1.14, family: "body", weight: 600, tracking: -.02 },
  { x: 31, y: 2071, w: 182, h: 64, text: "PARENTS ON PARENTAL LEAVE\nBuild a remote career close to your family.  ↘", size: 8, color: DARK, background: "#fbfafa", radius: 14, padding: 9, lineHeight: 1.14, family: "body", weight: 600, tracking: -.02 },
  { x: 88, y: 2170, w: 268, h: 65, text: "PEOPLE READY FOR CHANGE\nMove into a creative, in-demand career.  ↘", size: 8, color: DARK, background: "#fbfafa", radius: 14, padding: 9, lineHeight: 1.14, family: "body", weight: 600, tracking: -.02 },
  ...
  { x: 20, y: 2400, w: 338, h: 60, text: "01  STRATEGY\nAnalysis, positioning, content pillars and a content plan.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
  { x: 20, y: 2470, w: 338, h: 60, text: "02  VISUALS AND CONTENT\nCreative production, layout and video editing.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
  { x: 20, y: 2540, w: 338, h: 60, text: "03  PLATFORMS\nInstagram, Telegram and VK.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
  { x: 20, y: 2610, w: 338, h: 60, text: "04  INFLUENCER PARTNERSHIPS\nFinding creators and preparing integrations.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
  { x: 20, y: 2680, w: 338, h: 60, text: "05  AI TOOLS\nCopy, imagery and faster production.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
  { x: 20, y: 2750, w: 338, h: 60, text: "06  MARKETING FUNDAMENTALS\nHow content supports sales.", size: 9, color: WHITE, background: DARK, padding: 7, lineHeight: 1.16, family: "body", weight: 600, tracking: -.02 },
...
const tabletLayers: Layer[] = [
  ...
  { x: 65, y: 2482, w: 420, h: 162, text: "PEOPLE WHO WANT FREEDOM\nWork online from anywhere and keep travelling.  ↘", size: 16, color: DARK, background: "#fbfafa", radius: 24, padding: 18, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 488, y: 2603, w: 258, h: 145, text: "STUDENTS\nBuild a valuable skill and earn while studying.  ↘", size: 14, color: DARK, background: "#fbfafa", radius: 24, padding: 16, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 2651, w: 315, h: 142, text: "PARENTS ON PARENTAL LEAVE\nBuild a remote career close to your family.  ↘", size: 14, color: DARK, background: "#fbfafa", radius: 24, padding: 16, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  { x: 215, y: 2771, w: 510, h: 128, text: "PEOPLE READY FOR CHANGE\nMove into a creative, in-demand career.  ↘", size: 15, color: DARK, background: "#fbfafa", radius: 24, padding: 17, lineHeight: 1.14, family: "body", weight: 500, tracking: -.02 },
  ...
  { x: 34, y: 3125, w: 700, h: 88, text: "01  STRATEGY\nAnalysis, positioning, content pillars and a content plan.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 3220, w: 700, h: 100, text: "02  VISUALS AND CONTENT\nCreative production, layout and video editing.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 3327, w: 700, h: 100, text: "03  PLATFORMS\nInstagram, Telegram and VK.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 3434, w: 700, h: 100, text: "04  INFLUENCER PARTNERSHIPS\nFinding creators and preparing integrations.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 3541, w: 700, h: 95, text: "05  AI TOOLS\nCopy, imagery and faster production.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
  { x: 34, y: 3643, w: 700, h: 170, text: "06  MARKETING FUNDAMENTALS\nHow content supports sales and better commercial decisions.", size: 15, color: WHITE, background: DARK, radius: 22, padding: 14, lineHeight: 1.16, family: "body", weight: 500, tracking: -.02 },
