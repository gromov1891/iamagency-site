...
const tabletLayers: Layer[] = [
  ...
  { x: 34, y: 3125, w: 700, h: 88, text: "01  STRATEGY\nAnalysis, positioning, content pillars and a content plan.", size: 23, titleSize: 23, bodySize: 15, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
  { x: 34, y: 3220, w: 700, h: 100, text: "02  VISUALS AND CONTENT\nCreative production, layout and video editing.", size: 23, titleSize: 23, bodySize: 15, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
  { x: 34, y: 3327, w: 700, h: 100, text: "03  PLATFORMS\nInstagram, Telegram and VK.", size: 23, titleSize: 23, bodySize: 15, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
  { x: 34, y: 3434, w: 700, h: 100, text: "04  INFLUENCER PARTNERSHIPS\nFinding creators and preparing integrations.", size: 21, titleSize: 21, bodySize: 14, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
  { x: 34, y: 3541, w: 700, h: 95, text: "05  AI TOOLS\nCopy, imagery and faster production.", size: 23, titleSize: 23, bodySize: 15, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
  { x: 34, y: 3643, w: 700, h: 170, text: "06  MARKETING FUNDAMENTALS\nHow content supports sales and better commercial decisions.", size: 21, titleSize: 21, bodySize: 14, color: WHITE, background: DARK, radius: 22, padding: 14, variant: "program" },
