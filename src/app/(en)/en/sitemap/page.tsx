...
const groups = [
  { title: "Main", links: [["Home", "/en"], ["Services", "/en#uslugi"], ["Cases", "/en/cases"], ["Marketing", "/en/marketing"], ["Packages", "/en#tarify"], ["Insights", "/en/blog"], ["SMM School", "/en/smm-school"], ["Contacts", "/en/contacts"]] },
