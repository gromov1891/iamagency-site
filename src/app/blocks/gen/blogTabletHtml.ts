...
<a href="/blog?tag=${encodeURIComponent(tag)}" aria-label="Открыть статьи: ${tag}" style="width:${w}px;height:31.19px;position:absolute;left:${x}px;top:${y}px;display:block;text-decoration:none">
...
<img layer-name="30Файл  1" style="width:377.49px;height:377.49px;position:absolute;left:540px;top:550px;object-fit:contain" src="/blk/blog/orange_flower.webp" alt="" />
...
${chip(40, 751, 98.02, "смм", 52, "#8992E4", "SMM")}
${chip(40, 794.81, 170.06, "маркетинг", 124, "#FFAD19", "Маркетинг")}
${chip(289, 838.37, 170.06, "нейросети", 125, "#FFAD19", "Нейросети")}
${chip(289, 751, 125.5, "визуал", 81, "#8992E4", "Визуал")}
${chip(289, 794.56, 251, "социальные сети", 210, "#FF6B3D", "Социальные сети")}
${chip(40, 838.63, 205.7, "продвижение", 160, "#90BEE9", "Продвижение")}
</div>`;
