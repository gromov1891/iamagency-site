...
const ph = (
  ...
  if (_f) return `<img src="/blk/keisy/${_f}" alt="кейс I AM AGENCY - туризм" loading="lazy" style="position:absolute;left:${x}px;top:${y}px;width:${w}px;height:${h}px;${r ? `border-radius:${r};` : ""}object-fit:cover;" />`;
  ...
  <div style="position:absolute;left:638px;top:205px;width:737.16px;height:631.92px;">
    <div style="position:absolute;left:4.98px;top:0;width:113.2px;height:131.86px;">
      <div style="position:absolute;left:0;top:0;width:113.2px;height:113.2px;">
        ...
        <img src="/blk/keisy/tourism-02-542cbe.webp" alt="кейс I AM AGENCY - туризм" loading="lazy" style="position:absolute;left:0.08px;top:0.08px;width:113.2px;height:113.2px;border-radius:50%;border:3.61px solid #FFFFFF;box-sizing:border-box;;object-fit:cover;" />
      </div>
  ...
  <div style="position:absolute;left:65px;top:989.26px;width:1310px;height:684.19px;">
    ...
    <div style="position:absolute;left:32.98px;top:23.16px;width:127.71px;height:145.96px;">
      <div style="position:absolute;left:0;top:0;width:127.71px;height:127.71px;">
        ...
        <img src="/blk/keisy/tourism-33-7d4316.webp" alt="кейс I AM AGENCY - туризм" loading="lazy" style="position:absolute;left:0.09px;top:0.09px;width:127.71px;height:127.71px;border-radius:50%;border:4.08px solid #FFFFFF;box-sizing:border-box;;object-fit:cover;" />
      </div>
...
${b("50+")} довольных клиентов на туры и визы за 2 месяца</div>
    ...
    <div style="position:absolute;left:747.34px;top:11.23px;width:276.42px;height:672.96px;">
      ...
      <div style="position:absolute;left:45.72px;top:0;width:193.49px;height:148.77px;">
        <div style="position:absolute;left:0;top:0;width:193.49px;height:127.71px;">
          ...
          <img src="/blk/keisy/tourism-49-46cd20.webp" alt="кейс I AM AGENCY - туризм" loading="lazy" style="position:absolute;left:33.07px;top:0.1px;width:127.71px;height:127.71px;border-radius:50%;border:4.08px solid #FFFFFF;box-sizing:border-box;;object-fit:cover;" />
    ...
    <div style="position:absolute;left:1033.58px;top:11.23px;width:276.42px;height:672.96px;">
      ...
      <div style="position:absolute;left:46.78px;top:0;width:193.49px;height:148.77px;">
        <div style="position:absolute;left:0;top:0;width:193.49px;height:127.71px;">
          <div style="position:absolute;left:29px;top:-3.98px;width:135.87px;height:135.87px;border-radius:50%;background:${IG_GRAD};"></div>
          <img src="/blk/keisy/tourism-55-6e61ad.webp" alt="кейс I AM AGENCY - туризм" loading="lazy" style="position:absolute;left:33.07px;top:0.1px;width:127.71px;height:127.71px;border-radius:50%;border:4.08px solid #FFFFFF;box-sizing:border-box;;object-fit:cover;" />
        </div>
